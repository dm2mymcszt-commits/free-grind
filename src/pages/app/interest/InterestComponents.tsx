					...
					<div className="shrink-0 flex items-center justify-center h-12 w-12">
						{mode === "taps" ? (
							<div
								...
								style={{
									backgroundColor: `rgba(${emojiColorMap[tapType] || "255, 200, 0"}, 0.07)`,
									borderColor: `rgba(${emojiColorMap[tapType] || "255, 200, 0"}, 0.45)`,
									boxShadow: `0 2px 8px rgba(${emojiColorMap[tapType] || "255, 200, 0"}, 0.05)`,
									color: `rgb(${emojiColorMap[tapType] || "255, 200, 0"})`
								}}
							>
