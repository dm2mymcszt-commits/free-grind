    ...
    return (
        <div className={cn(!isDesktop && "bg-black flex", "w-full h-full")}>
            {/* MAGIC WRAPPER INJECTED HERE */}
                <SelectableItem
                    id={card.profileId}
                    profileId={card.profileId} // <-- ADD THIS
                    name={name}
                    viewType="grid"
                ...
                <div
                    className={cn(
                        "surface-card-grid overflow-hidden text-left transition-transform w-full h-full block relative",
                            ...
                            <div className={cn(
                                ...
                                {(isRightNow || isVisiting || isPopular) && (
                                    <div className="flex items-center gap-0.5">
                                        {/* FIXED: Icons wrapped in standard HTML spans for tooltips! */}
                                        {isPopular && (
                                            <span title="Popular" className="flex items-center justify-center">
                                                <Zap
                                        ...
                                        {isRightNow && (
                                            <span title="Right Now" className="flex items-center justify-center">
                                                <Droplet
                                        ...
                                        {isVisiting && (
                                            <span title={t("profile_details.visiting")} className="flex items-center justify-center">
                                                <Plane
