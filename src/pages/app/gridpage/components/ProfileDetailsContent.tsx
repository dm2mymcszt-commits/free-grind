								...
								{activeProfile.socialNetworks?.instagram?.userId && (
									<a
										...
										onClick={(e) => {
											e.preventDefault();
											e.stopPropagation();
											const handle = activeProfile.socialNetworks?.instagram?.userId;
											if (handle) {
										...
										className="flex min-h-11 cursor-pointer items-center gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface-2)] px-3 transition hover:border-[var(--accent)]"
									>
								...
								{activeProfile.socialNetworks?.twitter?.userId && (
									<a
										...
										onClick={(e) => {
											e.preventDefault();
											e.stopPropagation();
											const handle = activeProfile.socialNetworks?.twitter?.userId;
											if (handle) {
								...
								{activeProfile.socialNetworks?.facebook?.userId && (
									<a
										...
										onClick={(e) => {
											e.preventDefault();
											e.stopPropagation();
											const handle = activeProfile.socialNetworks?.facebook?.userId;
											if (handle) {
												const url = `https://facebook.com/${handle}`;
												void openUrl(url).catch(() => window.open(url, "_blank"));
											}
										}}
										target="_blank"
