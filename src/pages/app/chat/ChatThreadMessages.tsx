                ...
                {(() => {
                    ...
                    return threadMessages.map((message) => {
                        ...
                        const isMediaOnlyBubble =
                            isImageOnlyBubble || isVideoOnlyBubble || isAlbumOnlyBubble || isLocationOnlyBubble || isAlbumReactionBubble || Boolean(giphyUrl);
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* --- TRANSLATION ENGINE & TEXT RENDERING --- */}
                                            {!isMediaOnlyBubble && !isAudioOnlyBubble && !gaymojiUrl && !Boolean(giphyUrl)
                                            ...
                                            <div className="mt-1 flex items-center justify-between gap-2 text-[10px] opacity-80">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {isTranslateEnabled && !mine && displayText && !translations[message.messageId]?.text && !translations[message.messageId]?.loading ? (
                                                        <button
                                                            type="button"
                                                            onClick={(e) => {
                                                                e.stopPropagation();
                                                                void handleTranslate(message.messageId, typeof displayText === "string" ? displayText : "");
                                                            }}
